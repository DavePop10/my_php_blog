...
if (isset($_POST['submit']) && ($_POST['submit'] != "")) {
    if ($_POST['submit'] == 'reg') {
        ...
        {
            $msgreg='<div class = "alert alert-warning">Please check your password and try again</div>';
        }
    }
...
<html lang="en">
    ...
    <head>
        ...
        <title>SweetPieDating Login &amp; Register</title>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>BLOG</strong> Login &amp; Register Forms</h1>
                            <div class="description">
                            	<p>
	                            	A beautiful way to express yourself <strong>"login and register now"</strong> WorldWide match up for your taste!
                            	</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Sign up now</h3>
	                            		<p>Register and express ideas:</p>
	                        		</div>
	                        		<div class="form-top-right">
	                            ...
	                            <div class="form-bottom">
                                    ...
                                    <?php echo $msgreg; $msgreg=""; ?>
                                        ...
                                        <input type="hidden" name="submit" value="reg">
        	...
        	<div class="container">
        		<div class="row">
        			...
        			<div class="col-sm-8 col-sm-offset-2">
        				...
        				<p>Made by <a href="http://credential.php" target="_blank"><strong>Sweet Pie Dating</strong></a> 
